...
namespace TransportationClass
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Transportation Trans1 = new CarClass("Pyörä", "Jopo", "2010", 400);
            ...
            Console.WriteLine(Trans2.CarInfo());
            CarClass Trans3 = new CarClass("Auto", "BMW X5", "2017", 65000, "4,8L", "V8", 3);
            Console.WriteLine(Trans3.CarInfo());
            ...
            Console.WriteLine(Trans4.CarInfo());
